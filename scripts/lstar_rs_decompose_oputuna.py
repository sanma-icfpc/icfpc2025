...
def solve(
    ...
    learner = lstar_rs_decompose.LStarMooreRSDecomposeLearner(
        oracle,
        max_loops,
        num_random_walks,
...
if __name__ == "__main__":
    problem_names = ["primus", "secundus", "tertius", "quartus", "quintus"]
    threads = list()
    lock = threading.Lock()
    for problem_name in problem_names:
        ...
        def solve_local(problem_name: str, lock: threading.Lock):
            ...
            storage = f"sqlite:///rs_decompose.{study_name}.db"  # SQLite ファイルを指定
